...
def id3(data, uniqs, attrs, target):
    ...
    #Generate nodes for each unique attribute
    for attr in uniq_attrs:
        #Check to see if any unique attribute isnt included in the partitioned data for the attribute with the maximum information gain
        ...
        #Recursively keeps searching for nodes for the unique attribute in data partition (Parition done with the  attribute with the maximum information gain))
